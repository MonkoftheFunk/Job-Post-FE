        ...
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            <a :href="route('listings.index')" class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                ...
                <a v-if="route().current() != 'admin.listings.create'"
                   ...
                   class="inline-flex items-center bg-indigo-500 text-white border-0 py-1 px-3 focus:outline-none hover:bg-indigo-600 rounded text-base mt-4 md:mt-0">Post Job
